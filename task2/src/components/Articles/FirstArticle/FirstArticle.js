    ...
    <div className={styles.firstArticle__container}>
      <section className={styles.firstArticle__section} onClick={clickHandler}>
        ...
        <img
          ...
          alt="vintage-car"
        />
        <h3 className={styles.firstArticle__text}>Super Car</h3>
        <p className={styles.firstArticle__text}>
          ...
          iusto unde a praesentium officiis, omnis facere? Lorem ipsum dolor sit
          amet consectetur adipisicing elit. Pariatur molestias quam ipsam
          nesciunt. Veritatis et tempora corporis unde aspernatur dicta laborum
          ...
          amet. Corrupti magnam repudiandae nostrum incidunt eos omnis, dolores
          cum neque eaque possimus aperiam praesentium alias consectetur! Nisi
          iusto unde a praesentium officiis, os distinctio nobis necessitatibus
          ...
          neque eaque possimus aperiam praesentium alias consectetur! Nisi iusto
